...
interface ImageTrailProps {
  ...
  /** Only spawn trail items while the pointer is inside the container. */
...
const ImageTrail = ({
  ...
  useAnimationFrame((time) => {
    ...
    // Skip if the pointer is outside the container bounds
    if (confineToContainer && containerRef?.current) {
