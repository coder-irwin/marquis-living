...
function GalleryScene({
    ...
    // Handle scroll input — nudge the gallery WITHOUT blocking the page scroll.
    // (The original called event.preventDefault(), which traps page scrolling when
    //  the gallery is embedded in a normal scrolling layout. We keep the velocity
    //  nudge but let the page scroll through.)
