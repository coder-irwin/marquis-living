...
export default function InkReveal({
  ...
  // Holds the latest `loop` so it can re-schedule itself without referencing
  // its own const binding (which this project's lint rejects).
  ...
  // keep the ref pointed at the freshest loop closure
  useEffect(() => {
