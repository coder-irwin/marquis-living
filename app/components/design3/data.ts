...
export const STEPS = [
  ...
  },
  {
    no: "02",
    title: "Get matched",
    desc: "We pair you with a Marquis Manor designer whose taste fits yours — and book a one-to-one consultation.",
  },
  {
    no: "03",
  ...
  },
  {
    no: "04",
    title: "Shop the look",
    desc: "Get a curated shopping list of Marquis Manor pieces — delivered, styled and ready to live in.",
  },
];
...
export const FAQS = [
  { q: "How does online interior design work?", a: "You share your space and style, we match you with a Marquis Manor designer, and you receive photorealistic concepts plus a curated shopping list — all online, on your timeline." },
  ...
  { q: "Can I keep some of my existing pieces?", a: "Absolutely. Your designer works around the pieces you love and fills the gaps with Marquis Manor originals." },
